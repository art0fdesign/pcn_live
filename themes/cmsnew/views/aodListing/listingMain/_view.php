...
<div class="middleContent">
    <fieldset>
        <div class="widget">
            ...
            <div class="title1"><h6>Listing Data</h6></div>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <?php echo $form->textField( $model, 'listing_id', $readOnly ); ?>
                </div>            
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight"><?php echo $form->checkBox($model,'f_use_cat',array('id'=>'ch2','class'=>'styled')); ?></div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight"><?php echo $form->checkBox($model,'f_use_image',array('id'=>'ch6','class'=>'styled')); ?></div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight"><?php echo $form->checkBox($model,'f_use_detail',array('id'=>'ch5','class'=>'styled')); ?></div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight"><?php echo $form->checkBox($model,'f_use_widget',array('id'=>'ch4','class'=>'styled')); ?></div>
                <div class="clear"></div>
            </div>
