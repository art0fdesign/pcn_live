        ...
        <div class="widget">
            ...
            <fieldset>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight"><?php echo $form->textField($model,'file_name',$disabled); ?></div>
                        <div class="clear"></div>
                    </div>

                    <div class="formRow">
                        <?php echo $form->labelEx($model, 'cat_id'); ?>
                        <div class="formRight"><div class="select-list"><?php echo $form->dropDownList($model,'cat_id',CMap::mergeArray(array("0"=>"no category"),$model->getCategoryOptions()),$disabled); ?></div></div>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight"><?php echo $form->textField($model,'file_type',CMap::mergeArray(array('value'=>$model-> getReadableFileSize()),$disabled)); ?></div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight"><?php echo CHtml::textField('', $model->getFileMarkup(),CMap::mergeArray(array('class'=>'longText','id'=>'url'),$disabled)); ?></div>
                    <div class="clear"></div>
                </div>
                
                <div class="formRow">
                    <?php echo $form->labelEx($model, 'file_alt'); ?>
                    <div class="formRight"><?php echo $form->textField($model,'file_alt',CMap::mergeArray($disabled,array('class'=>'longText'))); ?></div>
                    <div class="clear"></div>
                </div>
                
                <div class="formRow">
                    <?php echo $form->labelEx($model, 'file_title'); ?>
                    <div class="formRight"><?php echo $form->textField($model,'file_title',CMap::mergeArray($disabled,array('class'=>'longText'))); ?></div>
                    <div class="clear"></div>
                </div>

                <div class="formRow">
                    <?php echo $form->labelEx($model, 'file_comment'); ?>
                    <div class="formRight"><?php echo $form->textarea($model,'file_comment',$disabled); ?></div>
                    <div class="clear"></div>
                </div>
