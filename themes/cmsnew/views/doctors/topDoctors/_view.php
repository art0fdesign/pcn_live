...
<div class="middleContent">
    <fieldset>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <?php echo CHtml::textField( '', $model->getMonth(), CMap::mergeArray($readOnly, array('class'=>'form'))); ?>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <?php echo CHtml::textField( '', $model->getDoctorName(),  CMap::mergeArray($readOnly, array('class'=>'form')) ); ?>
            </div>            
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow mb20">
            ...
            <div class="formRight">
                <?php echo $form->checkBox($model, 'f_status', array('id'=>'ch_status', 'class'=>'styled', 'disabled'=>'disabled')); ?>
