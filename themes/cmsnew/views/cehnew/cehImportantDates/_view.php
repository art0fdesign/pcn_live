...
<div class="middleContent">
    <fieldset>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <?php echo $form->textField( $model, 'date', $readOnly ); ?>
            </div>            
            <div class="clear"></div>
        </div>
    ...
    <fieldset>
        <div class="widget">
            ...
            <?php echo $form->textArea($model,'text',CMap::mergeArray($disabled,array('style'=>'width:468px;height:150px;'))); ?>
