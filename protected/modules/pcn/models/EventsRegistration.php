...
class EventsRegistration extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('first_name, surname, title_position, company, division_department, street_address, suburb, state, country, telephone, mobile, email, dietary_requirements', 'length', 'max'=>100),
            array('email', 'email'),
