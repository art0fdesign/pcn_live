...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'blog_name',array('size'=>50,'maxlength'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'blog_content'); ?>
		<?php echo $form->textArea($model,'blog_content',array('rows'=>6, 'cols'=>50)); ?>
	</div>
