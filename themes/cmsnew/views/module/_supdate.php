...
<div class="titleBlock ">
    <span><?php echo strtoupper($modelName); ?> MODULE:  Update Settings</span>
</div>
...
<div class="middleContent">
    ...
    <?php //echo CHtml::submitButton('Save', array('name'=>'save', 'class'=>'btn floatR')); ?>
    <div class="button-box mt20" style="float: right;">
        <?php echo CHtml::submitButton('Save', array('name'=>'save', 'class'=>'saveBtn')); ?><br/>
        <?php echo CHtml::link('Back to List',array('view','id'=>$model->id), array('class'=>'backBtn')); ?>
    </div>
