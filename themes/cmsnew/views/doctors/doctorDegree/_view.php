    ...
    <fieldset>
        <div class="widget">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <?php echo CHtml::textField( 'category_name', $model->category->cat_name, $readOnly ); ?>
                </div>            
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <?php echo $form->textField( $model, 'code', $readOnly ); ?>
                </div>            
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <?php echo $form->textField( $model, 'description', $readOnly ); ?>
                </div>            
                <div class="clear"></div>
            </div>
