...
<div class="middleContent">
    <fieldset>
        <div class="widget">
            ...
            <div class="title1"><h6>Service form Data</h6></div>
            ...
            <div class="formRow">
                ...
                <div class="formRight"><?php echo $form->textField($model,'serial_number',$disabled); ?></div>
                <div class="clear"></div>
            </div>

            <div class="formRow">
                <?php echo $form->labelEx($model, 'location'); ?>
                <div class="formRight"><?php echo $form->textField($model,'location',$disabled); ?></div>
                <div class="clear"></div>
            </div>
