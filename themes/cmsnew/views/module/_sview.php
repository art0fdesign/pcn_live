...
<div class="titleBlock"><span><?php echo strtoupper($modelName); ?> MODULE:  View Settings</span>
...
<fieldset>
    ...
    <?php //if( count($items) != 0 ) echo CHtml::link('Edit',array('update', 'id'=>$model->id), array('class'=>'btn floatR')); ?>
    <div class="button-box mt20" style="float: right;">
        <?php if( count($items) != 0 ) echo CHtml::link( 'Edit', array('update', 'id'=>$model->id), array('class'=>'saveBtn')); ?>
