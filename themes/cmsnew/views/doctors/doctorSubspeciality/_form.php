...
<div class="middleContent">
    <fieldset>
        ...
        <div class="title1"><h6>Subspeciality Data</h6></div>
        ...
        <div class="formRow mt30">
            ...
            <div class="formRight">
        		<?php echo $form->dropDownList($model,'spec_id', $specialities); ?>
        ...
        <div class="formRow">
    		<?php echo $form->labelEx($model,'subspec_name'); ?>
            <div class="formRight">
        		<?php echo $form->textField($model,'subspec_name',array('size'=>60,'maxlength'=>100)); ?>
        		<?php echo $form->error( $model, 'subspec_name' ); ?>
            </div>
            <div class="clear"></div>
        </div>
