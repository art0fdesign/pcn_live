       ...
       <div class="newsletterInfo blue chimpInfo"></div>
		...
		<fieldset>
		  <dl>
			...
			<dt class="floatL"><label for="ch2"><?php echo $settings['group3-title']['value']?></label></dt><br class="clear" />
			...
			<dt class="floatL"><label for="ch2"><?php echo $settings['group4-title']['value']?></label></dt><br class="clear" />	   
