...
<div class="middleContent">
    <fieldset>
        ...
        <div class="title1"><h6>Speciality Data</h6></div>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <?php echo CHtml::textField( 'cat_id', $model->category->cat_name, $readOnly ); ?>
            </div>            
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <?php echo $form->textField( $model, 'spec_name', $readOnly ); ?>
            </div>            
            <div class="clear"></div>
        </div>
